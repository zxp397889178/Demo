...
namespace UCSDK
{
    ...
    */
    ...
    {
    public:
		virtual bool GetMobileRegisterSMSes(const char* pszMobile, const char* pszCountryCode, const char* pszOrgName, const char* pszIdentifyCode, const char* pszSessionId, const char* pszLang) = 0;
		virtual bool GetMobileResetPasswordSMSes(const char* pszMobile, const char* pszCountryCode, const char* pszOrgName, const char* pszIdentifyCode, const char* pszSessionId, const char* pszLang) = 0;
    ...
    */
    typedef class IGetSMSes	GetSMSes;
}
