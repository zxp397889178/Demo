...
namespace UCSDK
{
    ...
    */
    class IMobileRegister
    {
    public:
        virtual bool Excute(const char* pszMobile, const char* pszPassword, const char* pszMobileCode, const char* pszCountryCode, const char* pszOrgName, const char* pszSessionId, const char* pszSessionKey) = 0;
    ...
    */
    ...
    typedef class IMobileRegister	MobileRegister;
}
