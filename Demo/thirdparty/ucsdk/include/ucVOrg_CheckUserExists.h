...
namespace UCSDK
{
	...
	*/
	class IVOrgCheckUserExsits
	{
	public:
		virtual bool Excute(const char* pszLoginName, const char* pszOrgName, const char* pszVOrgId, const char* pszDeviceId) = 0;
	...
	*/
	typedef class IVOrgCheckUserExsits	VOrgCheckUserExsits;
}