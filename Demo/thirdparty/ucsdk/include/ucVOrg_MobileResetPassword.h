...
namespace UCSDK
{
    ...
    */
    class IVOrgMobileResetPassword
    {
    public:
        virtual bool Excute(const char* pszMobile, const char* pszNewPassword, const char* pszMobileCode, const char* pszOrgId) = 0;
    ...
    */
	typedef class IVOrgMobileResetPassword	VOrgMobileResetPassword;
}
