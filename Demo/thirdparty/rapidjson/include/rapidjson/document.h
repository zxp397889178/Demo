...
public:
    ...
    */
	...
	Object GetObjectEx() { RAPIDJSON_ASSERT(IsObject()); return Object(*this); }//·ÀÖ¹Ãû×ÖÓëGDI+µÄºê³åÍ»
	ConstObject GetObjectEx() const { RAPIDJSON_ASSERT(IsObject()); return ConstObject(*this); }//·ÀÖ¹Ãû×ÖÓëGDI+µÄºê³åÍ»
    //@}
