...
namespace NDHttp
{
	NDHTTP_EXPORTS_API ndhttp_handle_t CreateRequest(const HttpRequest &request);
	NDHTTP_EXPORTS_API HttpResponseOutcome ExcuteRequest(ndhttp_handle_t handle);
	NDHTTP_EXPORTS_API bool CancelRequest(ndhttp_handle_t handle);
	NDHTTP_EXPORTS_API void CleanupRequest(ndhttp_handle_t handle);

	NDHTTP_EXPORTS_API ndhttpfile_handle_t CreateFileRequest(const HttpFileRequest &request);
	NDHTTP_EXPORTS_API HttpFileResponseOutcome ExcuteFileRequest(ndhttpfile_handle_t handle);
	NDHTTP_EXPORTS_API bool CancelFileRequest(ndhttpfile_handle_t handle);
	NDHTTP_EXPORTS_API void CleanupFileRequest(ndhttpfile_handle_t handle);
}
