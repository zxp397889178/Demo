// ----------------------------------------------------------------------------
// free_funcs.hpp :  implementation of the free functions of tiny_boost::format
// ----------------------------------------------------------------------------
...
namespace tiny_boost {
    ...
    namespace io {
         using ::tiny_boost::str; // keep compatibility with when it was defined in this N.S.
    }   // - namespace io
    ...
    {
        typedef tiny_boost::basic_format<Ch, Tr, Alloc>   format_t;
        if(f.items_.size()==0) 
            os << f.prefix_;
        else {
			...
			if (f.exceptions() & io::too_few_args_bit)
				...
				tiny_boost::throw_exception(io::too_few_args(f.cur_arg_, f.num_args_)); 
